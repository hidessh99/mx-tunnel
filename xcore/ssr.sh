...
Start_SSR(){
	check_pid
	wget -O /etc/init.d/ssrmu "https://${Server}/ssrmu"
...
Install_SSR
wget -O /usr/bin/ssr https://${Server}/ssrmu.sh && chmod +x /usr/bin/ssr
wget -O /usr/bin/add-ssr https://${Server}/add-ssr.sh && chmod +x /usr/bin/add-ssr
wget -O /usr/bin/del-ssr https://${Server}/del-ssr.sh && chmod +x /usr/bin/del-ssr
wget -O /usr/bin/renew-ssr https://${Server}/renew-ssr.sh && chmod +x /usr/bin/renew-ssr
